  ...
  useEffect(() => {
    if (isSearchOpen) {
      async function loadQuickData() {
        try {
          const [studRes, hostRes] = await Promise.all([
          ...
          setSearchData({
            students: studJson.data || [],
            hostels: hostJson.data || [],
          });
        } catch (e) {
    ...
    <header className="sticky top-0 z-30 h-[72px] w-full bg-white/80 dark:bg-[#161C24]/80 backdrop-blur-md border-b border-dashed border-[#E5E8EB] dark:border-[#2E3844] transition-all flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {showNotifs && (
            <div className="absolute right-0 mt-2 w-[340px] rounded-2xl bg-white dark:bg-[#212B36] border border-[#E5E8EB] dark:border-[#2E3844] shadow-[var(--shadow-dropdown)] z-50 overflow-hidden">
              ...
              <div className="px-5 py-3 border-t border-[#F1F3F5] dark:border-[#2E3844]">
                <button type="button" className="w-full text-center text-sm font-bold text-[#00A76F] hover:text-[#007856] transition-colors">
                  View All
                </button>
              </div>
            </div>
        ...
        <div className="relative ml-1">
          ...
          {showMenu && (
            <div className="absolute right-0 mt-2 w-[220px] rounded-2xl bg-white dark:bg-[#212B36] border border-[#E5E8EB] dark:border-[#2E3844] shadow-[var(--shadow-dropdown)] z-50 overflow-hidden">
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-start justify-center p-4 pt-16 sm:pt-24 animate-in fade-in duration-200">
          <div className="w-full max-w-2xl bg-white dark:bg-[#212B36] rounded-3xl border border-[#E5E8EB] dark:border-[#2E3844] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            {/* Search Input Bar */}
            <div className="p-4 border-b border-[#F1F3F5] dark:border-[#2E3844] flex items-center gap-3">
              ...
              <button
                ...
                className="px-2.5 py-1 text-xs font-bold rounded-lg bg-[#F4F6F8] dark:bg-[#141A21] text-[#919EAB] hover:text-[#1C252E] dark:hover:text-white border border-[#E5E8EB] dark:border-[#2E3844]"
              >
                ESC
              </button>
            </div>
            ...
            <div className="max-h-[420px] overflow-y-auto p-4 space-y-4">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-[#919EAB]">
                              Campus Code: <span className="font-mono font-semibold">{h.code}</span> • {h.status}
                            </p>
                          </div>
                        </div>
                        <span className="text-xs font-bold text-[#00A76F] flex items-center gap-1 group-hover:translate-x-1 transition-transform">
              ...
              {/* 3. Quick Pages / Commands Navigation */}
              <div className="space-y-2">
                <span className="text-[11px] font-extrabold uppercase tracking-wider text-[#919EAB] px-2 block">
                  Quick Navigation ({filteredLinks.length})
                </span>
