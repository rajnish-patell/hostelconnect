...
export const hostelSchema = z.object({
  ...
  maxCallsPerStudentPerDay: z.coerce.number().min(1).max(50).default(10),
  maxCallsPerParentPerDay: z.coerce.number().min(1).max(50).default(10),
...
// =============================================================================
// CALL EXTENSION & EMERGENCY OVERRIDE SCHEMAS
// =============================================================================
export const extendCallSchema = z.object({
  extensionMinutes: z.coerce.number().min(1, "Must extend at least 1 minute").max(30, "Maximum extension is 30 minutes").default(5),
});

export const emergencyOverrideSchema = z.object({
  studentId: z.string().min(1, "Student ID is required"),
  reason: z.string().min(3, "Emergency reason is required"),
  notes: z.string().optional().nullable(),
});
