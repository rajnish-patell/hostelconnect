...
import { Video, Lock, Loader2, CheckCircle2, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="rounded-3xl border-[#E5E8EB] dark:border-[#2E3844] bg-white dark:bg-[#212B36] shadow-xl p-2 sm:p-4">
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl font-extrabold text-[#1C252E] dark:text-white">Set New Password</CardTitle>
            <CardDescription className="text-xs text-[#919EAB]">Enter and confirm your new secure password</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            {successMsg ? (
              <div className="p-4 bg-[#EAFBF1] dark:bg-[#00A76F]/10 border border-[#C8FACD] dark:border-[#00A76F]/20 text-[#007856] dark:text-[#5BE49B] rounded-2xl text-xs flex items-center gap-2 font-bold">
              ...
              <form onSubmit={handleUpdate} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="password" className="text-xs font-bold text-[#1C252E] dark:text-white">New Password (min 8 chars)</Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="confirmPassword" className="text-xs font-bold text-[#1C252E] dark:text-white">Confirm New Password</Label>
                  <div className="relative">
                    <Lock className="w-4 h-4 text-[#919EAB] absolute left-3.5 top-3.5" />
                    <Input
                      id="confirmPassword"
                ...
                >
                  {loading ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : "Save New Password"}
                </Button>
              </form>
            )}
          </CardContent>
